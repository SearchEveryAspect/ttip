...
public class StaggerMain {
    /**
     * Creates and returns a tokenizer for the given language.
     */
    public static Tokenizer getTokenizer(Reader reader, String lang) {
        Tokenizer tokenizer;
    ...
    public static TaggedToken[][][] getSUCFold(
     ...
     */
    public static TaggedToken[][][] getFold(
    ...
    public static BufferedReader openUTF8File(String name)
    throws IOException {
        if(name.equals("-"))
